    ...
    <Grid columns={4} className="address-input-container">
      ...
      <Grid.Column>
        <Form.Input
          ...
          error={
            formik.errors.nombreCalle && formik.touched.nombreCalle
              ? { content: formik.errors.nombreCalle, pointing: "below" }
              : null
          }
          className="address-input"
          fluid
      ...
      <Grid.Column>
        <Form.Input
          ...
          onBlur={formik.handleBlur}
          error={
            formik.errors.numeroPrincipal && formik.touched.numeroPrincipal
              ? { content: formik.errors.numeroPrincipal, pointing: "below" }
              : null
          }
          className="address-input"
          fluid
      ...
      <Grid.Column>
        <Form.Input
          ...
          onBlur={formik.handleBlur}
          error={
            formik.errors.numeroSecundario && formik.touched.numeroSecundario
              ? { content: formik.errors.numeroSecundario, pointing: "below" }
              : null
          }
          className="address-input"
          fluid
